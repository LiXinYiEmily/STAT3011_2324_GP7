...
```
## Error in {: task 1 failed - "could not find function "cv.glmnet""
```
...
##                                                     s0
## (Intercept)                                -2.82105713
## age_group                                  -0.02408190
## dependents_groups                           .         
## rsll_groups                                 .         
## ocll_quantile_groups                        .         
## sqrt_debtratio                              0.08619991
## sqrt_monthlyincome                          .         
## sqrt_revolvingutilizationofunsecuredlines   1.59869028
## category_pastdueMostly.30.59.Days.Past.Due  .         
## category_pastdueMostly.60.89.Days.Past.Due  0.59597288
## category_pastdueMostly.90.days...Past.Due   0.76792376
## category_pastdueNo.Past.Due                -1.22902064
```
...
##   -> predicted values  :  numerical, min =  0.01520982 , mean =  0.0692592 , max =  0.4647789  
##   -> residual function :  difference between y and yhat (  default  )
##   -> residuals         :  numerical, min =  -0.4616692 , mean =  -7.389586e-10 , max =  0.9847902  
