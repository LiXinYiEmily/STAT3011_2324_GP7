...
##                                                     s0
## (Intercept)                                -2.90771214
## age_group                                   .         
## dependents_groups                           .         
## rsll_groups                                 .         
## ocll_quantile_groups                        .         
## sqrt_debtratio                              0.07503305
## sqrt_monthlyincome                          .         
## sqrt_revolvingutilizationofunsecuredlines   1.61813433
## category_pastdueMostly.30.59.Days.Past.Due  .         
## category_pastdueMostly.60.89.Days.Past.Due  0.60046575
## category_pastdueMostly.90.days...Past.Due   0.77041420
## category_pastdueNo.Past.Due                -1.23028571
```
...
```
##   -> predicted values  :  numerical, min =  0.01570421 , mean =  0.0692592 , max =  0.4595695  
...
```
##   -> residuals         :  numerical, min =  -0.451059 , mean =  -4.444068e-10 , max =  0.9842958  
